...
export function HeroSlider() {
    ...
    try {
      ...
      if (popularProduct) {
        newSlides.push({
          ...
          description: popularProduct.description || "Our customers' favorite choice with excellent reviews and proven quality.",
          image: popularProduct.image_url || "https://images.unsplash.com/photo-1541140532154-b024d705b90a?w=800&h=400&fit=crop",
          buttonText: "Shop Now",
      ...
      if (cheapestProduct) {
        newSlides.push({
          ...
          description: cheapestProduct.description || "Get the best value for your money with this amazing deal that won't last long.",
          image: cheapestProduct.image_url || "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&h=400&fit=crop",
      ...
      if (latestProduct) {
        newSlides.push({
          ...
          description: latestProduct.description || "Be among the first to experience our newest addition to the collection.",
          image: latestProduct.image_url || "https://images.unsplash.com/photo-1597852074816-d933c7d2b988?w=800&h=400&fit=crop",
  ...
  if (slides.length === 0) {
    return <div className="h-[500px] bg-gray-200 animate-pulse rounded-lg"></div>;
  }
      ...
      {slides.map((slide, index) => (
        ...
        >
          <div className="relative h-full">
            ...
            {/* Badge */}
            <div className={`absolute top-6 left-6 ${slide.badgeColor} text-white px-4 py-2 rounded-full font-semibold text-sm`}>
              {slide.badge}
            </div>
